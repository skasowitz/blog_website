...
ggplot(
  storage_data,
  aes(x = reorder(reservoir, values, median), y = values, fill = reservoir)
) +
  geom_boxplot(outlier.color = "red", outlier.size = 1.5) +
  coord_flip() +
  labs(
    title = "Distribution of Water Storage by Reservoir",
